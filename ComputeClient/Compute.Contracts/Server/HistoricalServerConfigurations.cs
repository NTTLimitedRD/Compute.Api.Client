namespace DD.CBU.Compute.Api.Contracts.Server
{
    ...
    public partial class historicalServerConfigurations
    {

        private HistoricalServerConfigurationType[] historicalServerConfigurationField;
        ...
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("historicalServerConfiguration")]
        public HistoricalServerConfigurationType[] historicalServerConfiguration
        {
            get
            {
                return this.historicalServerConfigurationField;
            }
            set
            {
                this.historicalServerConfigurationField = value;
            }
        }
